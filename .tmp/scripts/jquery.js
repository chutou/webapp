...
(function ($) {
  ...
  AdGallery.prototype = {
    ...
    in_transition: false,
    animations: false,
    init: function init(wrapper, settings) {
      var context = this;
      ...
      var nextimage_callback = function nextimage_callback(callback) {
    ...
    addAnimation: function addAnimation(name, fn) {
      if ($.isFunction(fn)) {
    ...
    initNextAndPrev: function initNextAndPrev() {
    ...
    initBackAndForward: function initBackAndForward() {
      var context = this;
     ...
     */
    _getContainedImageSize: function _getContainedImageSize(image_width, image_height) {
     ...
     */
    _centerImage: function _centerImage(img_container, image_width, image_height) {
    ...
    _getDescription: function _getDescription(image) {
      var desc = false;
     ...
     */
    showImage: function showImage(index, callback) {
     ...
     *                          and it's animation has finished
     */
    _showWhenLoaded: function _showWhenLoaded(index, callback) {
    ...
    prevImage: function prevImage(callback) {
    ...
    preloadImage: function preloadImage(index, callback) {
      if (this.images[index]) {
        var image = this.images[index];
    ...
    highLightThumb: function highLightThumb(thumb) {
    ...
    fireCallback: function fireCallback(fn) {
      if ($.isFunction(fn)) {
        fn.call(this);
      };
    }
  ...
  AdGallerySlideshow.prototype = {
    ...
    init: function init(nextimage_callback, settings) {
      var context = this;
    ...
    _next: function _next() {
      ...
      this.countdown_interval = setInterval(function () {
        ...
        if (slide_timer >= context.settings.speed) {
          var whenNextIsShown = function whenNextIsShown() {
